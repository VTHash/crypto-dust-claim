...
var AppKitBaseClient = class {
  ...
  async initialize(options) {
    ...
    if (OptionsController.state.features?.reownAuthentication || OptionsController.state.remoteFeatures?.reownAuthentication) {
      const { ReownAuthentication } = await import("./features-JLEER7QB.js");
...
var AppKit = class extends AppKitBaseClient {
  ...
  async loadModalComponents(features, remoteFeatures) {
    ...
    if (usingEmbeddedWallet) {
      featureImportPromises.push(import("./embedded-wallet-KS7YMO7W.js"));
    }
    if (remoteFeatures.email) {
      featureImportPromises.push(import("./email-NJNWCLPN.js"));
    }
    if (remoteFeatures.socials) {
      featureImportPromises.push(import("./socials-SWVSM52T.js"));
    }
    if (remoteFeatures.swaps && remoteFeatures.swaps.length > 0) {
      featureImportPromises.push(import("./swaps-KPDWO2LG.js"));
    }
    if (features.send) {
      featureImportPromises.push(import("./send-FCOMNX3O.js"));
    }
    if (features.receive) {
      featureImportPromises.push(import("./receive-PTWUGF53.js"));
    }
    if (remoteFeatures.onramp && remoteFeatures.onramp.length > 0) {
      featureImportPromises.push(import("./onramp-WBQ5F66P.js"));
    }
    if (remoteFeatures.payWithExchange) {
      featureImportPromises.push(import("./pay-with-exchange-KGXAEXV2.js"));
    }
    if (remoteFeatures.activity) {
      featureImportPromises.push(import("./transactions-B5TD6XYY.js"));
    }
    if (features.pay || remoteFeatures.payments) {
      featureImportPromises.push(import("./exports-4GH3TIBH.js"));
    }
    if (remoteFeatures.emailCapture) {
      featureImportPromises.push(import("./data-capture-6XVCQEAZ.js"));
    }
    await Promise.all([
      ...featureImportPromises,
      import("./exports-PT5A6T2E.js"),
      import("./w3m-modal-KAPSJB3C.js")
    ]);
  }
};
...
//# sourceMappingURL=chunk-M6Q3HR6X.js.map
