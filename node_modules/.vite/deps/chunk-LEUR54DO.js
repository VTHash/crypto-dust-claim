...
var AppKitBaseClient = class {
  ...
  async initialize(options) {
    ...
    if (OptionsController.state.features?.reownAuthentication || OptionsController.state.remoteFeatures?.reownAuthentication) {
      const { ReownAuthentication } = await import("./features-TZMKFZ5O.js");
...
var AppKit = class extends AppKitBaseClient {
  ...
  async loadModalComponents(features, remoteFeatures) {
    ...
    if (usingEmbeddedWallet) {
      featureImportPromises.push(import("./embedded-wallet-B7TI2ZGH.js"));
    }
    if (remoteFeatures.email) {
      featureImportPromises.push(import("./email-4F3LVTYS.js"));
    }
    if (remoteFeatures.socials) {
      featureImportPromises.push(import("./socials-DDQWUWGD.js"));
    }
    if (remoteFeatures.swaps && remoteFeatures.swaps.length > 0) {
      featureImportPromises.push(import("./swaps-YXGR74UX.js"));
    }
    if (features.send) {
      featureImportPromises.push(import("./send-JHIWJQ5F.js"));
    }
    if (features.receive) {
      featureImportPromises.push(import("./receive-OXRH43KL.js"));
    }
    if (remoteFeatures.onramp && remoteFeatures.onramp.length > 0) {
      featureImportPromises.push(import("./onramp-3IA6RTME.js"));
    }
    if (remoteFeatures.payWithExchange) {
      featureImportPromises.push(import("./pay-with-exchange-XA7O6FPX.js"));
    }
    if (remoteFeatures.activity) {
      featureImportPromises.push(import("./transactions-KUQPLH3W.js"));
    }
    if (features.pay || remoteFeatures.payments) {
      featureImportPromises.push(import("./exports-XVZP6X3H.js"));
    }
    if (remoteFeatures.emailCapture) {
      featureImportPromises.push(import("./data-capture-7V6X7HLF.js"));
    }
    await Promise.all([
      ...featureImportPromises,
      import("./exports-NWZOVCM7.js"),
      import("./w3m-modal-ZXNWLH3M.js")
    ]);
  }
};
...
//# sourceMappingURL=chunk-LEUR54DO.js.map
