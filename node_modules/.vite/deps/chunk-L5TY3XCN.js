...
var secp256r1 = p256;
var mapSWU2 = (() => mapToCurveSimpleSWU2(Fp256, {
  A: CURVE_A,
  B: CURVE_B,
  ...
  G2: {
    ...
    fromBytes: (bytes) => {
      ...
      if (value.length === 96 && compressed) {
        ...
        const Y_bit = y.c1 === _0n8 ? y.c0 * _2n7 / P : y.c1 * _2n7 / P ? _1n8 : _0n8;
    ...
    toBytes: (c, point, isCompressed) => {
      ...
      if (isCompressed) {
        if (isZero)
          return concatBytes(COMPRESSED_ZERO, numberToBytesBE(_0n8, len));
        const flag = Boolean(y.c1 === _0n8 ? y.c0 * _2n7 / P : y.c1 * _2n7 / P);
...
*/
//# sourceMappingURL=chunk-L5TY3XCN.js.map
