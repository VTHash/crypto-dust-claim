...
var AppKitBaseClient = class {
  ...
  async initialize(options) {
    ...
    if (OptionsController.state.features?.reownAuthentication || OptionsController.state.remoteFeatures?.reownAuthentication) {
      const { ReownAuthentication } = await import("./features-F7UGQSTB.js");
...
var AppKit = class extends AppKitBaseClient {
  ...
  async loadModalComponents(features, remoteFeatures) {
    ...
    if (usingEmbeddedWallet) {
      featureImportPromises.push(import("./embedded-wallet-H7RDWTFP.js"));
    }
    if (remoteFeatures.email) {
      featureImportPromises.push(import("./email-RIYAGQ4Q.js"));
    }
    if (remoteFeatures.socials) {
      featureImportPromises.push(import("./socials-LPLJORMM.js"));
    }
    if (remoteFeatures.swaps && remoteFeatures.swaps.length > 0) {
      featureImportPromises.push(import("./swaps-VYG4P27P.js"));
    }
    if (features.send) {
      featureImportPromises.push(import("./send-L23AANAW.js"));
    }
    if (features.receive) {
      featureImportPromises.push(import("./receive-W2OEFVS3.js"));
    }
    if (remoteFeatures.onramp && remoteFeatures.onramp.length > 0) {
      featureImportPromises.push(import("./onramp-J4JXSWWK.js"));
    }
    if (remoteFeatures.payWithExchange) {
      featureImportPromises.push(import("./pay-with-exchange-UQCJPSTL.js"));
    }
    if (remoteFeatures.activity) {
      featureImportPromises.push(import("./transactions-PFLUBCWK.js"));
    }
    if (features.pay || remoteFeatures.payments) {
      featureImportPromises.push(import("./exports-3CEIGYJY.js"));
    }
    if (remoteFeatures.emailCapture) {
      featureImportPromises.push(import("./data-capture-CTYDQW5N.js"));
    }
    await Promise.all([
      ...featureImportPromises,
      import("./exports-5DVHWGT2.js"),
      import("./w3m-modal-Q34ERFTY.js")
    ]);
  }
};
...
//# sourceMappingURL=chunk-EVOZSXPQ.js.map
