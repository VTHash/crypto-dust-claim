...
var EthersAdapter = class extends AdapterBlueprint {
  ...
  async createEthersConfig() {
    ...
    async function getSafeProvider() {
      const { SafeProvider } = await import("./SafeProvider-EFQ36LJW.js");
      const { default: SafeAppsSDK } = await import("./esm-R23RDK5M.js");
    ...
    async function getCoinbaseProvider() {
      ...
      try {
        const { createCoinbaseWalletSDK } = await import("./dist-K4OVK2DK.js");
        if (typeof window === "undefined") {
          return void 0;
        }
