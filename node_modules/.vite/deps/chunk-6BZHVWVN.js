...
var AppKitBaseClient = class {
  ...
  async initialize(options) {
    ...
    if (OptionsController.state.features?.reownAuthentication || OptionsController.state.remoteFeatures?.reownAuthentication) {
      const { ReownAuthentication } = await import("./features-2KFNE7TQ.js");
...
var AppKit = class extends AppKitBaseClient {
  ...
  async loadModalComponents(features, remoteFeatures) {
    ...
    if (usingEmbeddedWallet) {
      featureImportPromises.push(import("./embedded-wallet-HVBHPIN2.js"));
    }
    if (remoteFeatures.email) {
      featureImportPromises.push(import("./email-OVXK4K64.js"));
    }
    if (remoteFeatures.socials) {
      featureImportPromises.push(import("./socials-N5MSBYGN.js"));
    }
    if (remoteFeatures.swaps && remoteFeatures.swaps.length > 0) {
      featureImportPromises.push(import("./swaps-CUHDRL5X.js"));
    }
    if (features.send) {
      featureImportPromises.push(import("./send-SP75CYXX.js"));
    }
    if (features.receive) {
      featureImportPromises.push(import("./receive-PRJZCFDJ.js"));
    }
    if (remoteFeatures.onramp && remoteFeatures.onramp.length > 0) {
      featureImportPromises.push(import("./onramp-S7B373NU.js"));
    }
    if (remoteFeatures.payWithExchange) {
      featureImportPromises.push(import("./pay-with-exchange-PYYD4YLQ.js"));
    }
    if (remoteFeatures.activity) {
      featureImportPromises.push(import("./transactions-YYC5ZQPD.js"));
    }
    if (features.pay || remoteFeatures.payments) {
      featureImportPromises.push(import("./exports-XYZIB6GM.js"));
    }
    if (remoteFeatures.emailCapture) {
      featureImportPromises.push(import("./data-capture-L7G2LHM7.js"));
    }
    await Promise.all([
      ...featureImportPromises,
      import("./exports-5CT5SZQQ.js"),
      import("./w3m-modal-GDQZJJHQ.js")
    ]);
  }
};
...
//# sourceMappingURL=chunk-6BZHVWVN.js.map
