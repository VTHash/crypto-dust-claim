import {
  ...
  secp256r1,
  toSmartAccount
} from "./chunk-L5TY3XCN.js";
import {
  createJSONStorage,
  createStore,
  persist
} from "./chunk-HO7XYTR5.js";
import {
  clsx,
  init_clsx_m
} from "./chunk-PFXUVOKI.js";
...
import {
  ...
  erc20Abi,
  isAddressEqual
} from "./chunk-G3VRPRTL.js";
import "./chunk-KASMAJTU.js";
import {
  defineChain
} from "./chunk-G2R45Z6F.js";
...
function fromHex3(signature) {
  ...
  const r3 = BigInt(slice2(signature, 0, 32));
...
function parseAsn1Signature(bytes2) {
  ...
  const r3 = BigInt(fromBytes(bytes2.slice(r_start, r_end)));
...
async function sign2(options) {
  ...
  const r3 = toBigInt2(slice3(signature_bytes, 0, 32));
...
// node_modules/@wagmi/connectors/node_modules/idb-keyval/dist/index.js
...
function toWebAuthnSignature({ webauthn, signature }) {
  const { r: r3, s: s3 } = fromHex3(signature);
...
*/
//# sourceMappingURL=dist-DOEIOFPD.js.map
