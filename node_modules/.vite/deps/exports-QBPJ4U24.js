import {
  RpcSchema_exports,
  mini_exports
} from "./chunk-EOKENUSD.js";
import "./chunk-HO7XYTR5.js";
import {
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await import("./dist-WA3BTPQU.js");
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-DOEIOFPD.js");
  ...
  return createConnector((wagmiConfig) => {
    ...
    return {
      ...
      async getPortoInstance() {
        porto_promise ??= (async () => {
          const { Porto } = await import("./_dist-FK5BEI7W.js");
          return Porto.create({
            ...parameters,
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-PH2J7PHT.js");
    ...
    async getProvider({ chainId } = {}) {
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-JT76DIBB.js");
...
*/
//# sourceMappingURL=exports-QBPJ4U24.js.map
